 ...
 */
class UUV1PosePlugin : public plugin::PluginBase
{
public:
        UUV1PosePlugin() : PluginBase(),
                mp_nh("~UUV1Pose")
        ...
        void initialize(UAS &uas_)
        {
                ...
                uuv1_pose_sub = mp_nh.subscribe("pose", 1, &UUV1PosePlugin::uuv1_pose_cb, this);
...
private:
        ...
        void uuv1_pose_send
                (uint64_t usec,
                        ...
                        Eigen::Vector3d &v)
        {
                mavlink::common::msg::UUV_ONE_POS pos;
        ...
        /* -*- mid-level helpers -*- */
        void uuv1_pose_cb(const geometry_msgs::PoseStamped::ConstPtr &pose)
        {
                ...
                uuv1_pose_send(pose->header.stamp.toNSec() / 1000,
                                q,
                                position);
        }
...
PLUGINLIB_EXPORT_CLASS(mavros::extra_plugins::UUV1PosePlugin, mavros::plugin::PluginBase)
