 ...
 */
class UUV3PosePlugin : public plugin::PluginBase
{
public:
        UUV3PosePlugin() : PluginBase(),
                mp_nh("~UUV3Pose")
        { }
        ...
        void initialize(UAS &uas_)
        {
                ...
                uuv3_pose_sub = mp_nh.subscribe("pose", 1, &UUV3PosePlugin::uuv3_pose_cb, this);
...
private:
        ...
        void uuv3_pose_send
                (uint64_t usec,
                        ...
                        Eigen::Vector3d &v)
        {
                mavlink::common::msg::UUV_THREE_POS pos;
        ...
        /* -*- mid-level helpers -*- */
        void uuv3_pose_cb(const geometry_msgs::PoseStamped::ConstPtr &pose)
        {
                ...
                uuv3_pose_send(pose->header.stamp.toNSec() / 1000,
                                q,
                                position);
        }
...
PLUGINLIB_EXPORT_CLASS(mavros::extra_plugins::UUV3PosePlugin, mavros::plugin::PluginBase)
