 ...
 */
class UUV4PosePlugin : public plugin::PluginBase
{
public:
        UUV4PosePlugin() : PluginBase(),
                mp_nh("~UUV4Pose")
        { }
        ...
        void initialize(UAS &uas_)
        {
                ...
                uuv4_pose_sub = mp_nh.subscribe("pose", 1, &UUV4PosePlugin::uuv4_pose_cb, this);
...
private:
        ...
        void uuv4_pose_send
                (uint64_t usec,
                        ...
                        Eigen::Vector3d &v)
        {
                mavlink::common::msg::UUV_FOUR_POS pos;
        ...
        /* -*- mid-level helpers -*- */
        void uuv4_pose_cb(const geometry_msgs::PoseStamped::ConstPtr &pose)
        {
                ...
                uuv4_pose_send(pose->header.stamp.toNSec() / 1000,
                                q,
                                position);
        }
...
PLUGINLIB_EXPORT_CLASS(mavros::extra_plugins::UUV4PosePlugin, mavros::plugin::PluginBase)
